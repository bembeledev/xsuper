...
public abstract class Stmt {
    ...
    public static class Enum extends Stmt {
        public final Token name;
        public final List<EnumVariant> variants; // Agora guarda as variantes avançadas

        public Enum(Token name, List<EnumVariant> variants) {
            this.name = name;
    ...
    // Dentro do teu Stmt.java
    public static class EnumVariant {
        public final Token name;
        public final List<Token> params; // Parâmetros que a variante guarda (ex: [codigo, mensagem])

        public EnumVariant(Token name, List<Token> params) {
            this.name = name;
            this.params = params;
        }
    ...
    public static class Param {
        ...
        public Param(Token name, TypeNode typeNode, Expr defaultValue, boolean isRest) {
            this.name = name;
