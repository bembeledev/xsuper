    ...
    public static XPLModel buildNativeModel() {
        if (XplElement.nativeModel == null) {
            ...
            List<Stmt.Param> paramsChild = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "child", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsNewRef = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "newNode", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "refNode", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsNewOld = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "newNode", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "oldNode", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsStyle = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "property", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "value", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsHTML = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "html", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsEvtName = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "eventName", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsPosHTML = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "position", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "html", null, 0, 0), null, null,false)
            );
            XplElement.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
