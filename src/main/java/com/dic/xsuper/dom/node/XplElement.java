...
import com.dic.xsuper.dom.node.helpers.XplElementUtils;
...
public class XplElement extends XplInstance implements XplNativeObject{
    ...
    public com.dic.xsuper.engine.poo.XplInstance hostComponent = null;
    ...
    public String _internalUid = XplNode.generateUid();
    ...
    public void callAction(String eventName, Interpreter interpreter) {
        ...
        if (xplCode != null && interpreter != null) {
            ...
            try {
                ...
                Environment globais = interpreter.globals;
                ...
                try {
                    ...
                    if (this.hostComponent != null) {
                        com.dic.xsuper.engine.poo.XplInstance host = this.hostComponent;
    ...
    public void setAttribute(String name, Object value) {
        ...
        UiEventPublisher.publishDomMutated(this._internalUid, name, value);
    }
    ...
    public void set(Token name, Object value) {
        ...
        if (propName.equalsIgnoreCase("innerHTML")) {
            ...
            UiEventPublisher.publishDomMutated(this._internalUid, propName, value);
            return;
        }
        if (propName.equalsIgnoreCase("textContent") || propName.equalsIgnoreCase("innerText")) {
            this.textContent = value != null ? value.toString() : "";
            this.children.clear();
            UiEventPublisher.publishDomMutated(this._internalUid, "textContent", value);
            return;
        }
