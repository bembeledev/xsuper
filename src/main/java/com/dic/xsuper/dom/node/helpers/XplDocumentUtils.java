package com.dic.xsuper.dom.node.helpers;
    ...
    public static XPLModel buildNativeModel() {
        if (XplDocument.nativeModel == null) {
            ...
            List<Stmt.Param> params1 = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "tagName", null, 0, 0), null, null,false)
            );
            ...
            List<Stmt.Param> params2 = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "namespaceURI", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "qualifiedName", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsData = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "data", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsName = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "name", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsId = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "id", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsClass = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "className", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsSelector = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "selector", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsWrite = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "text", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsEventListener = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "type", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "listener", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsEvent = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "event", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsImport = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "node", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "deep", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsExec = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "commandId", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "showUI", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "value", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsOpen = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "url", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "name", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "features", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsPoint = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "x", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "y", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsIterator = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "root", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "whatToShow", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
            ...
            List<Stmt.Param> paramsProp = List.of(
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "propName", null, 0, 0), null, null,false)
            );
            XplDocument.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
