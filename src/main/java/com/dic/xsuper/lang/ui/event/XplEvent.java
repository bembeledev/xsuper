...
public class XplEvent extends XplInstance implements XplNativeObject {
    ...
    public XplEvent(XplEventType eventType, Object target, float mouseX, float mouseY, XplKeyCode keyCode) {
        ...
        // Guarda as coordenadas antigas no novo formato dinâmico
        ...
        invokeMethod(); // Expõe os métodos ao interpretador XPL
    }

    /**
     * Construtor Moderno (Padrão W3C)
     */
    ...
    public String toString() {
        return "XplEvent{type='" + type + "', target=" + target + ", defaultPrevented=" + defaultPrevented + '}';
    }
}