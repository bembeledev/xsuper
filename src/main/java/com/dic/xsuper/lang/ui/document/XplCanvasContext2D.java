...
public class XplCanvasContext2D extends XplInstance implements XplNativeObject{
    ...
    public void invokeMethod() {
        ...
        this.fields.put("setLineWidth", new com.dic.xsuper.lang.XplCallable() {
            @Override public int arity() { return 1; }
            @Override public Object call(com.dic.xsuper.lang.Interpreter intp, java.util.List<com.dic.xsuper.lang.Expr.CallArg> args) {
        ...
        this.fields.put("setLineCap", new com.dic.xsuper.lang.XplCallable() {
            @Override public int arity() { return 1; }
            @Override public Object call(com.dic.xsuper.lang.Interpreter intp, java.util.List<com.dic.xsuper.lang.Expr.CallArg> args) {
    ...
    private static void addVoidMethod(XPLModel model, String name, int paramsCount) {
        ...
        for(int i = 0; i < paramsCount; i++) {
            params.add(new Stmt.Param(new Token(TokenType.IDENTIFIER, "arg" + i, null, 0, 0), null, null));
        }
