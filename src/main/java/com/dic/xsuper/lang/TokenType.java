...
public enum TokenType {
    ...
    PUB,
    PROT,
    PRIV, AS, THIS, ABSTRACT, SUPER, STATIC, DEFAULT, TRY, CATCH, FINALLY, THROW, THROWS, READONLY, FINAL, BANG, TYPEOF, TYPE, INSTANCE, AND, BIT_AND, OR, BIT_OR, BIT_XOR, SHIFT_LEFT, SHIFT_RIGHT, STRICT_NOT_EQUAL, STRICT_EQUAL, T_BOOL, CASE, SWITCH,
