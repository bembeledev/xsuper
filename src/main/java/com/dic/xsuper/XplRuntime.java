...
public class XplRuntime {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // ⭐ O DETETIVE DA RAIZ DO PROJETO ⭐
            // Precisamos de encontrar a pasta onde está o sdm.lock (a raiz do projeto FileManager),
            ...
            System.err.println(ConsoleTheme.ERROR + ">> ERRO FATAL: " + e.toString() + ConsoleTheme.RESET);
