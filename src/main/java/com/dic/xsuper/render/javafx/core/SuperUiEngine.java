...
import com.dic.xsuper.dom.reactivity.DomEvaluator;
...
import com.dic.xsuper.render.javafx.helpers.SuperUiEngineUtils;
...
import com.dic.xsuper.dom.css.*;
import com.dic.xsuper.render.javafx.css.media.JavaFxMediaListener;
import com.dic.xsuper.render.javafx.css.media.XplMediaNode;
import com.dic.xsuper.dom.event.XplEvent;
import com.dic.xsuper.dom.html.*;
import com.dic.xsuper.render.javafx.layout.scroll.DefaultScrollBarRenderer;
import com.dic.xsuper.render.javafx.layout.scroll.ScrollEngine;
import com.dic.xsuper.dom.reactivity.XplReactiveState;
import com.dic.xsuper.dom.reactivity.XplReactivityRenderer;
import com.dic.xsuper.render.javafx.window.MainWindow;
...
public class SuperUiEngine extends XplInstance implements XplNativeObject {
    ...
    private final com.dic.xsuper.render.javafx.animation.XplAnimationManager animationManager = new com.dic.xsuper.render.javafx.animation.XplAnimationManager();

    public com.dic.xsuper.render.javafx.animation.XplAnimationManager getAnimationManager() {
...
// 👇 A MUDANÇA É AQUI: Usamos 'interpreter.globals' em vez de 'Environment'
        interpreter.globals.addListener(new Environment.XplEnvironmentListener() {
            @Override
        ...
        UiEventBusSubscriber.register(this);
    }
    ...
    public void executeInlineScript(String scriptCallback, XplEvent event) {
        ...
        new InlineScriptExecutor(this.interpreter, this)
