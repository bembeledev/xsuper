...
import com.dic.xsuper.dom.html.HtmlTagUtils;
     ...
     public static XPLModel buildNativeModel() {
        if (SuperUiEngine.nativeModel == null) {
            ...
            List<Stmt.Param> paramsEvent = List.of(
                    ...
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "payload", null, 0, 0), null, null,false),
                    new Stmt.Param(new Token(TokenType.IDENTIFIER, "targetId", null, 0, 0), null, null,false)
            );
            SuperUiEngine.nativeModel.addMethod(new Stmt.Function(
                    null, false, false,
